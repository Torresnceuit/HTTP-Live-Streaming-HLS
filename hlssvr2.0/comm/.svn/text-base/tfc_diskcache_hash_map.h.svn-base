...
#pragma pack()
	...
	public:
		...
		THashNode* insert_node_metadata(TMBHashKey &key, int new_len, int expiretime);
		...
		//insert or update
		//修改节点,只写元数据
		THashNode* update_node_metadata(THashNode* node, int new_len, int expiretime);
